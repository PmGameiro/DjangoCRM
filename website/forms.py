...
class SignUpForm(UserCreationForm):
    email = forms.EmailField(label="", widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'E-mail '
                                                                                                             'Address'}))
    first_name = forms.CharField(label="", max_length=10, widget=forms.TextInput(attrs={'class': 'form-control',
...
class AddRecordForm(forms.ModelForm):
    ...
    email = forms.CharField(required=True, widget=forms.TextInput(attrs={'class': 'form-control', 'placeholder': 'E-mail'}), label="")
